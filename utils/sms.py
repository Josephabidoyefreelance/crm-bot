...
# Your Close.com API key (ensure this is loaded securely from environment variable)
...
# Your verified Close.com phone number
...
def send_sms(to_phone, text, lead_id=None):
    ...
    - lead_id: (optional) lead identifier in Close.com
    """
    sms_data = {
        "from": FROM_NUMBER,
        "to": to_phone,
